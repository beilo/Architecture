package com.minister.architecture.ui.journalism.child;
...
import com.minister.architecture.viewmodel.JournalismViewModel;
...
public class JournalismListFragment extends BaseSupportFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new JournalismAdapter(R.layout.item_tech, new ArrayList<JournalismBean.ListBean>());
    ...
    private void loadData() {
        ...
        mJournalismViewModel.getJournalismList("头条", 40, 0)
                .compose(RxHelp.<JournalismBean>rxScheduler())
